...
run_check "Проверка работоспособности сайта на HQ-SRV" "timeout 10 curl -I http://172.16.1.1"
run_check "Проверка работоспособности сайта на BR-SRV" "timeout 10 curl -I http://172.16.2.1"
else
